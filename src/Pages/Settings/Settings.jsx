...
import { Settings as SettingsIcon, Bell, Lock, Palette, Database, Shield, HelpCircle, Trash2 } from 'lucide-react';
...
const SettingsPage = () => {
  ...
  const [settings, setSettings] = useState({
    ...
    expenseTrackingReminders: false
  });
  ...
  return (
    <div className={styles.container}>
      ...
      <div className={styles.settingsGrid}>
        ...
        <div className={styles.card}>
          <div className={styles.cardHeader}>
            <HelpCircle size={24} className={styles.cardIcon} />
            <h2>Farm Alerts</h2>
          </div>
          <div className={styles.settingsList}>
            <div className={styles.settingItem}>
              <div>
                <div className={styles.settingLabel}>Health Monitoring Alerts</div>
                <div className={styles.settingDescription}>Alerts for bird health issues</div>
              </div>
              <label className={styles.toggle}>
                <input
                  type="checkbox"
            ...
            <div className={styles.settingItem}>
              <div>
                <div className={styles.settingLabel}>Inventory Alerts</div>
                <div className={styles.settingDescription}>Low stock and expiry warnings</div>
              </div>
              <label className={styles.toggle}>
                <input
                  type="checkbox"
            ...
            <div className={styles.settingItem}>
              <div>
                <div className={styles.settingLabel}>Expense Tracking Reminders</div>
                <div className={styles.settingDescription}>Reminders to log expenses</div>
              </div>
              <label className={styles.toggle}>
                <input
                  type="checkbox"
                  checked={settings.expenseTrackingReminders}
                  onChange={() => handleToggle('expenseTrackingReminders')}
                />
                <span className={styles.slider}></span>
              </label>
            </div>
        ...
        <div className={`${styles.card} ${styles.dangerCard}`}>
          <div className={styles.cardHeader}>
            <Trash2 size={24} className={styles.cardIconDanger} />
            <h2>Danger Zone</h2>
          </div>
          <div className={styles.settingsList}>
